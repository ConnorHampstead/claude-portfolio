...
coin flip.
## Current book state
*Auto-generated 2026-09-22 13:05 UTC. These are live figures - use them, do not estimate.*

- Equity: **$102,521.18**
- Cash: $63,821.96
- Session P&L so far: +0.98% (kill switch at -3.0%)
...
|---|---|---|---|---|---|---|---|---|
| DAL | long | 457 | 80.38 | 84.68 | +1,963 (+5.3%) | 78.2 (no live order) | 84.90 | DAL is a high-beta short on jet fuel that the market already marked down ~17% from its 52-week high of $95.68 on the Ira |
